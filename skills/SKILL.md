...
|             参考文件             | 何时需要                                                 |
| :------------------------------: | -------------------------------------------------------- |
|    [reference\bar0line0box.md](reference\bar0line0box.md)    | 当用户需要绘制柱状图，折线图，箱线图以及复合图表         |
| [reference\scatter0violin0heat.md](reference\scatter0violin0heat.md) | 当用户需要绘制散点图，小提琴图，热力图以及变体，复合图表 |
