...
| Skill                                                      | 类型                 | 说明                                                 | 状态 |
| ---------------------------------------------------------- | -------------------- | ---------------------------------------------------- | ---- |
| [TediousPlotting-skills/skills/Plot-skill](skills/Plot-skill) | 覆盖各类型的常见图表 | 用于数据统计分析，趋势，分布，对比，相关性，误差范围 | 完善 |
| [skills/DL-skill](skills/DL-skill)                            | 深度学习框架，布局图 | 用于深度学习框架可视化，架构模块化布局               | 草稿 |
